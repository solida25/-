...
import { AuthProvider } from "./contexts/AuthContext"; // Importa AuthProvider dal percorso corretto
...
const PageTransition = ({ children }) => {
  ...
  return (
    <TransitionGroup component={null}>
      {/* CSSTransition applica le classi .page-enter, .page-enter-active, ecc. */}
      <CSSTransition key={location.key} classNames="page" timeout={300}>
        {/* Mettiamo un wrapper per applicare le classi di animazione */}
      ...
      <ThemeProvider theme={theme}>
        <ErrorBoundary>
          <BrowserRouter>
            <AuthProvider>
              {" "}
              {/* Sposta AuthProvider all'interno di BrowserRouter */}
              <GlobalStyle />
              {/* Avvolgiamo AppRoutes dentro PageTransition 
                  per animare il cambio di route */}
              <PageTransition>
                <AppRoutes />
              </PageTransition>
            </AuthProvider>
